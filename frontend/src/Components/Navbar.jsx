...
export default function Navbar() {
  ...
  return (
    <header className=" flex justify-around items-center py-3 bg-white/50 backdrop-blur-sm  sticky top-2 rounded-full left-0 z-50 border border-gray-300  w-[90%] mx-auto">
